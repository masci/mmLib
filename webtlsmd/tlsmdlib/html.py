...
class Report(object):
    ...
    def html_title(self, title):
        ...
        l  = ['<table border="0" width="100%" style="background-color:#eeeeee"><tr>',
              ...
              '<td align="right" valign="top"><font size="-5">TLSMD Version %s</font></td>' % (settings.VERSION),
              '</tr></table>',
    ...
    def html_foot(self):
        ...
        l  = ['<table border="0" width="100%" style="background-color:#eeeeee"><tr>',
              ...
              '<td align="center"><font size="-5">Released %s by <i>%s</i></font></td>' % (settings.RELEASE_DATE, settings.EMAIL),
              '<td align="right"><font size="-5">TLSMD Version %s</font></td>' % (settings.VERSION),
              '</tr></table>',
              '</body></html>']
...
class HTMLReport(Report):
    ...
    def html_tls_graph_path(self, chain, ntls):
        ...
        l = ['<hr>',
             ...
             'width=%d,height=%d,screenX=10,screenY=10,left=10,top=10&quot;);' % (settings.JMOL_SIZE, settings.JMOL_SIZE),
             ...
             'return false;">Animate Screw Displacement with JMol</a>' % (jmol_animate_path, settings.JMOL_SIZE, settings.JMOL_SIZE),
    ...
    def html_refinement_prep(self):
        ...
        l = [self.html_head(title),
             ...
             '</center>',
             '<br>',
             '<form enctype="multipart/form-data" action="/tlsmd/refineprep.html" method="post">',
