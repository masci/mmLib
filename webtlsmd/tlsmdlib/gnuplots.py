...
class GNUPlot(object):
    ...
    def __init__(self, **args):
        ...
        self.font_path    = args.get("font_path", settings.GNUPLOT_FONT)
...
class TranslationAnalysis(GNUPlot):
    ...
    def write_data_file(self):
        ...
        for itls, tls in enumerate(self.cpartition.iter_tls_segments()):
            ...
            t1 = Gaussian.GAUSS3C[settings.ADP_PROB] * tls_info["Tr1_rmsd"]
            t2 = Gaussian.GAUSS3C[settings.ADP_PROB] * tls_info["Tr2_rmsd"]
            t3 = Gaussian.GAUSS3C[settings.ADP_PROB] * tls_info["Tr3_rmsd"]
